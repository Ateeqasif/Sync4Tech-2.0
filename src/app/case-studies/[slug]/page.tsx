...
const caseStudies: Record<string, {
  ...
  'healthcare-patient-intake': {
    ...
    subtitle: 'How a Global healthcare provider network eliminated admin bottlenecks across 12 sites.',
    challengeBody: [
      'A healthcare provider operating 12 clinics was processing patient intake entirely on paper and manual data entry. Each new patient arrival required front-desk staff to spend 45 minutes on forms, data entry, and cross-referencing across three disconnected systems.',
    ...
    quoteAuthor: 'Operations Director, Healthcare Provider Network',
    relatedSolutions: [
  ...
  'financial-risk-dashboard': {
    ...
    subtitle: 'How a financial services firm replaced manual reporting with a real-time risk intelligence platform.',
    challengeBody: [
      'A mid-market financial services firm was compiling its risk dashboard by hand analysts pulling data from six disconnected systems, reconciling figures in Excel, and spending three full working days each month preparing a report that was already outdated by the time it reached the board.',
    ...
    quoteAuthor: 'Head of Risk, Financial Services Firm',
    relatedSolutions: [
      { slug: 'data-intelligence', name: 'Data Intelligence' },
  ...
  'ecommerce-inventory-ai': {
    ...
    subtitle: 'How an e-commerce retailer replaced gut-feel buying with AI-powered demand forecasting.',
    challengeBody: [
    ...
    quoteAuthor: 'Head of Merchandising, E-Commerce Retailer',
    relatedSolutions: [
      { slug: 'predictive-analytics', name: 'Predictive Analytics' },
  ...
  'real-estate-crm-automation': {
    ...
    subtitle: 'How a real estate agency automated its entire lead nurture and CRM workflow.',
    challengeBody: [
      'A residential and commercial agency with 12 agents was losing leads to competitors due to slow follow-up. The average response time to new enquiries was 4 hours well above the industry benchmark of under 5 minutes for optimal conversion.',
    ...
    quoteAuthor: 'Managing Director, Real Estate Agency',
    relatedSolutions: [
      { slug: 'workflow-orchestration', name: 'Workflow Orchestration' },
      { slug: 'process-automation', name: 'Process Automation' },
    ],
  ...
  'logistics-route-optimisation': {
    ...
    subtitle: 'How a logistics company saved £180K annually with AI-powered route optimisation.',
    challengeBody: [
      'A regional logistics company operating 45 vehicles was planning routes manually each morning dispatchers printing maps, calling drivers, and adjusting plans reactively when deliveries were missed or addresses were wrong.',
    ...
    quoteAuthor: 'Fleet Director, Logistics Provider',
    relatedSolutions: [
      { slug: 'ai-enablement', name: 'AI Enablement' },
      { slug: 'data-intelligence', name: 'Data Intelligence' },
      { slug: 'workflow-orchestration', name: 'Workflow Orchestration' },
  ...
  'legal-document-automation': {
    ...
    subtitle: 'How a law firm recovered hundreds of billable hours with AI document automation.',
    challengeBody: [
      'A law firm with 24 fee earners was losing significant billable revenue to non-billable document work. Solicitors were spending 2–3 hours per day drafting standard documents NDAs, engagement letters, standard clauses from scratch or from outdated templates.',
    ...
    quoteAuthor: 'Managing Partner, Law Firm',
    relatedSolutions: [
      { slug: 'ai-enablement', name: 'AI Enablement' },
      { slug: 'process-automation', name: 'Process Automation' },
      { slug: 'workflow-orchestration', name: 'Workflow Orchestration' },
