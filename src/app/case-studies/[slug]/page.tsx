              ...
              {cs.metrics.map((m, i) => (
                <div key={i} className="p-10 text-center relative overflow-hidden">
                  ...
                  <div className="relative">
                    <div className="font-inter-tight font-black text-white text-5xl mb-2">{m.value}</div>
        ...
        <div className="section-container">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {related.map((s, idx) => {
              ...
              return (
                <Link key={s} href={`/case-studies/${s}`} className="group block bg-white dark:bg-[#0a1628] rounded-2xl overflow-hidden border border-black/8 dark:border-white/10 hover:border-[#007cf4]/30 hover:shadow-md transition-all">
                  <div className="h-[3px] w-full" style={{ background: gradients[idx % 3] }} />
                  <div className="p-6">
                    <span className="inline-block bg-[#007cf4]/10 text-[#007cf4] text-xs font-bold uppercase tracking-widest px-2.5 py-1 rounded-full mb-3">{r.industry}</span>
                    <h3 className="font-inter-tight font-bold text-black dark:text-white mb-2 group-hover:text-[#007cf4] transition-colors leading-snug">{r.title} {r.highlight}</h3>
