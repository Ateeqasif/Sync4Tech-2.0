      ...
      <section className="py-section bg-white dark:bg-gray-900">
        <div className="section-container max-w-4xl mx-auto">
          ...
          >
            ...
            <h2 style={{ fontWeight: 700, letterSpacing: '-0.003em', lineHeight: 1.05, color: 'var(--text-primary)' }} className="font-inter-tight text-3xl md:text-4xl">What Our Clients Say</h2>
          </motion.div>
