      ...
      <section className="bg-[#f8faff] dark:bg-gray-900 py-20">
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <h2 className="font-inter-tight font-black text-2xl text-gray-900 mb-6">Common Challenges</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {service.features.map((feature, i) => (
              ...
              >
                ...
                <h3 className="font-inter-tight font-black text-lg text-gray-900 mb-2">{feature.title}</h3>
      ...
      <section className="bg-white py-20">
        <div className="section-container">
          ...
          >
            ...
            <h2 className="font-inter-tight font-black text-3xl text-gray-900">Use Cases</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {service.useCases.map((uc, i) => (
              <motion.div
                key={i}
                className="rounded-2xl p-6 border border-gray-100 hover:border-[#007cf4]/30 hover:shadow-md transition group"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: '-80px' }}
                transition={{ duration: 0.6, delay: i * 0.1, ease: EASE }}
              >
                ...
                <h3 className="font-inter-tight font-black text-lg text-gray-900 mb-3 group-hover:text-[#007cf4] transition-colors">{uc.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {service.process.map((step, i) => (
              ...
              >
                ...
                <h3 className="font-inter-tight font-black text-lg text-gray-900 mb-2">{step.title}</h3>
