...
const orbitConfig: Record<IndustrySlug, {
  ...
  healthcare: {
    ...
    nodes: [
      ...
      { label: 'EMR System', angle: -30, color: '#36c5f0' },
      { label: 'Billing', angle: 30, color: '#007cf4' },
      { label: 'Compliance', angle: 90, color: '#36c5f0' },
      { label: 'Scheduling', angle: 150, color: '#007cf4' },
      { label: 'Staff Portal', angle: 210, color: '#36c5f0' },
    ],
  },
  'financial-services': {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'Transactions', angle: -30, color: '#36c5f0' },
      { label: 'CRM', angle: 30, color: '#007cf4' },
      { label: 'Reporting', angle: 90, color: '#36c5f0' },
      { label: 'Compliance', angle: 150, color: '#007cf4' },
      { label: 'Onboarding', angle: 210, color: '#36c5f0' },
    ],
  },
  manufacturing: {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'Quality Control', angle: -30, color: '#36c5f0' },
      { label: 'Maintenance', angle: 30, color: '#007cf4' },
      { label: 'Supply Chain', angle: 90, color: '#36c5f0' },
      { label: 'Inventory', angle: 150, color: '#007cf4' },
      { label: 'ERP', angle: 210, color: '#36c5f0' },
    ],
  },
  'retail-ecommerce': {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'Inventory', angle: -30, color: '#36c5f0' },
      { label: 'CRM', angle: 30, color: '#007cf4' },
      { label: 'Marketing', angle: 90, color: '#36c5f0' },
      { label: 'Fulfilment', angle: 150, color: '#007cf4' },
      { label: 'Analytics', angle: 210, color: '#36c5f0' },
    ],
  },
  'real-estate': {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'CRM', angle: -30, color: '#36c5f0' },
      { label: 'Listings', angle: 30, color: '#007cf4' },
      { label: 'Viewings', angle: 90, color: '#36c5f0' },
      { label: 'Contracts', angle: 150, color: '#007cf4' },
      { label: 'Reporting', angle: 210, color: '#36c5f0' },
    ],
  },
  logistics: {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'Route AI', angle: -30, color: '#36c5f0' },
      { label: 'Drivers', angle: 30, color: '#007cf4' },
      { label: 'Customer', angle: 90, color: '#36c5f0' },
      { label: 'TMS', angle: 150, color: '#007cf4' },
      { label: 'Invoicing', angle: 210, color: '#36c5f0' },
    ],
  },
  education: {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'SIS', angle: -30, color: '#36c5f0' },
      { label: 'LMS', angle: 30, color: '#007cf4' },
      { label: 'Parent Portal', angle: 90, color: '#36c5f0' },
      { label: 'Finance', angle: 150, color: '#007cf4' },
      { label: 'Reporting', angle: 210, color: '#36c5f0' },
    ],
  },
  legal: {
    ...
    nodes: [
      ...
      { label: 'Documents', angle: -30, color: '#36c5f0' },
      { label: 'Billing', angle: 30, color: '#007cf4' },
      { label: 'Client Portal', angle: 90, color: '#36c5f0' },
      { label: 'Compliance', angle: 150, color: '#007cf4' },
      { label: 'Deadlines', angle: 210, color: '#36c5f0' },
    ],
  },
  'technology-saas': {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'CRM', angle: -30, color: '#36c5f0' },
      { label: 'Support', angle: 30, color: '#007cf4' },
      { label: 'Analytics', angle: 90, color: '#36c5f0' },
      { label: 'Billing', angle: 150, color: '#007cf4' },
      { label: 'Onboarding', angle: 210, color: '#36c5f0' },
    ],
  },
  'professional-services': {
    ...
    nodes: [
      ...
      { label: 'CRM', angle: -30, color: '#36c5f0' },
      { label: 'Billing', angle: 30, color: '#007cf4' },
      { label: 'Resources', angle: 90, color: '#36c5f0' },
      { label: 'Reporting', angle: 150, color: '#007cf4' },
      { label: 'Onboarding', angle: 210, color: '#36c5f0' },
    ],
  },
  'hospitality-travel': {
    ...
    nodes: [
      ...
      { label: 'PMS', angle: -30, color: '#36c5f0' },
      { label: 'Guests', angle: 30, color: '#007cf4' },
      { label: 'Revenue', angle: 90, color: '#36c5f0' },
      { label: 'Reviews', angle: 150, color: '#007cf4' },
      { label: 'Loyalty', angle: 210, color: '#36c5f0' },
    ],
  },
  'nonprofit-public-sector': {
    eyebrow: 'Intelligence Layer',
    ...
    nodes: [
      ...
      { label: 'Donors', angle: -30, color: '#36c5f0' },
      { label: 'Grants', angle: 30, color: '#007cf4' },
      { label: 'Impact', angle: 90, color: '#36c5f0' },
      { label: 'Reporting', angle: 150, color: '#007cf4' },
      { label: 'Volunteers', angle: 210, color: '#36c5f0' },
    ],
  },
}
...
export default function IndustryPage({ params }: { params: { slug: string } }) {
  ...
  const cfg = orbitConfig[params.slug as IndustrySlug] ?? null
  ...
  return (
    <>
      ...
      <IndustryContent ind={ind} slug={params.slug} orbitConfig={cfg} />
