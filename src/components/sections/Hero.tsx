...
const slides = [
  {
    ...
    accentColor: '#007cf4',
    h1Line1: 'Build Intelligent',
    h1Line2: 'Business Operations',
    h1Line3: 'That Scale Fast',
  ...
  },
  {
    ...
    accentColor: '#36c5f0',
    h1Line1: 'Connect Your Data',
    h1Line2: 'Make Confident Decisions',
    h1Line3: 'In Real Time',
  ...
  },
  {
    ...
    accentColor: '#033a9d',
    h1Line1: 'Strategy Before Technology',
    h1Line2: 'Execution With Governance',
    h1Line3: 'Results That Last',
