...
const slides = [
  {
    ...
    accentColor: '#007cf4',
    h1Line1: 'Build Intelligent Business Operations',
    h1Line2: 'That Scale Without Friction',
    h1Line3: 'And Grow Without Headcount',
  ...
  },
  {
    ...
    accentColor: '#36c5f0',
    h1Line1: 'Connect All Your Data',
    h1Line2: 'Make More Confident Decisions',
    h1Line3: 'Faster Than Ever Before',
  ...
  },
  {
    ...
    accentColor: '#033a9d',
    h1Line1: 'Strategy Before The Technology',
    h1Line2: 'Execution With Clear Governance',
    h1Line3: 'Results That Actually Last',
