...
const slides = [
  {
    ...
    accentColor: '#007cf4',
    h1Line1: 'Build Intelligent Business',
    h1Line2: 'Operations That Scale',
    h1Line3: 'Without The Friction',
  ...
  },
  {
    ...
    accentColor: '#36c5f0',
    h1Line1: 'Connect Your Scattered',
    h1Line2: 'Data Into One',
    h1Line3: 'Trusted Business View',
  ...
  },
  {
    ...
    accentColor: '#033a9d',
    h1Line1: 'Strategy Before You',
    h1Line2: 'Build, Governance',
    h1Line3: 'That Delivers Results',
