...
export default function Insights() {
  ...
  return (
    <section className="py-section bg-white dark:bg-gray-900" id="insights">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filtered.slice(1).map((article, i) => (
                  <Link
                    ...
                    className="group cursor-pointer rounded-2xl overflow-hidden border border-black/8 dark:border-white/10 hover:border-[#007cf4]/30 transition-colors duration-300 shadow-sm hover:shadow-md bg-white dark:bg-gray-800"
                  >
