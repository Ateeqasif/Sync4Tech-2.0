...
function TiltCard({ industry, i }: { industry: typeof industries[0]; i: number }) {
  ...
  return (
    ...
    <motion.div
      ref={ref}
      className="group relative bg-white dark:bg-gray-800 border border-[#007cf4]/10 dark:border-white/10 rounded-2xl p-6 overflow-hidden cursor-pointer"
...
export default function Industries() {
  return (
    <section className="py-section bg-white dark:bg-gray-900" id="industries">
