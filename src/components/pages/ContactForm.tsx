...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <section className="py-section bg-[#f8faff] dark:bg-[#060d24]">
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <div className="bg-white dark:bg-[#0a1a4a] border border-[#007cf4]/15 rounded-3xl p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input required value={form.name} onChange={e => set('name', e.target.value)} type="text" placeholder="Jane Smith" className="w-full px-4 py-3 rounded-xl border border-[#007cf4]/15 bg-[#f8faff] dark:bg-[#050f2e] text-black dark:text-white text-sm outline-none focus:border-[#007cf4]/60 transition-colors" />
                      </div>
                      <div>
                        <label className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">Work Email *</label>
                        <input required value={form.email} onChange={e => set('email', e.target.value)} type="email" placeholder="jane@company.com" className="w-full px-4 py-3 rounded-xl border border-[#007cf4]/15 bg-[#f8faff] dark:bg-[#050f2e] text-black dark:text-white text-sm outline-none focus:border-[#007cf4]/60 transition-colors" />
                      </div>
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">Company Name *</label>
                      <input required value={form.company} onChange={e => set('company', e.target.value)} type="text" placeholder="Acme Corp" className="w-full px-4 py-3 rounded-xl border border-[#007cf4]/15 bg-[#f8faff] dark:bg-[#050f2e] text-black dark:text-white text-sm outline-none focus:border-[#007cf4]/60 transition-colors" />
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">Company Size</label>
                        <select value={form.size} onChange={e => set('size', e.target.value)} className="w-full px-4 py-3 rounded-xl border border-[#007cf4]/15 bg-[#f8faff] dark:bg-[#050f2e] text-black dark:text-white text-sm outline-none focus:border-[#007cf4]/60 transition-colors">
                      ...
                      <div>
                        ...
                        <select value={form.industry} onChange={e => set('industry', e.target.value)} className="w-full px-4 py-3 rounded-xl border border-[#007cf4]/15 bg-[#f8faff] dark:bg-[#050f2e] text-black dark:text-white text-sm outline-none focus:border-[#007cf4]/60 transition-colors">
                    ...
                    <div>
                      ...
                      <textarea required value={form.challenge} onChange={e => set('challenge', e.target.value)} rows={4} placeholder="Describe the challenge you are trying to solve..." className="w-full px-4 py-3 rounded-xl border border-[#007cf4]/15 bg-[#f8faff] dark:bg-[#050f2e] text-black dark:text-white text-sm outline-none focus:border-[#007cf4]/60 transition-colors resize-none" />
                    </div>
                    <button
                      type="submit"
            ...
            >
              {/* Email + badge */}
              <div className="bg-white dark:bg-[#0a1a4a] border border-[#007cf4]/15 rounded-2xl p-6">
              ...
              {[
                ...
                <div key={office.city} className="bg-white dark:bg-[#0a1a4a] border border-[#007cf4]/15 rounded-2xl p-5 flex items-start gap-4">
      ...
      {/* Trust signals */}
      <section className="py-8 bg-white dark:bg-[#050f2e] border-t border-[#007cf4]/10">
      ...
      <section className="py-section bg-[#f8faff] dark:bg-[#060d24]">
        <div className="section-container max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {FAQ.map((faq, i) => (
              <div key={i} className="bg-white dark:bg-[#0a1a4a] border border-[#007cf4]/15 rounded-2xl overflow-hidden">
